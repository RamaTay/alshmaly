      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div key={index} className="bg-[#b9a779] rounded-2xl p-8 text-center hover:bg-[#054239] transition-all duration-500 group shadow-md h-full flex flex-col justify-between">
              <div>
