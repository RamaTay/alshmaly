          ...
          {services.map((service, index) => (
            <div key={index} className="group relative">
              <div className="bg-[#054239] rounded-2xl p-8 text-center hover:bg-gray-50 transition-all duration-500 group-hover:shadow-xl">
                <div className="w-16 h-16 bg-[#054239]  rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-white group-hover:text-[#b9a779] transition-all duration-300">
